...
function setTranslationData(translationObj, translations, lang) {
    Object.entries(translations).forEach(function (_a) {
        ...
        if (trans && typeof trans === "object") {
            ...
            translationObj[langKey] = __assign({}, translationObj[langKey], (_b = {}, _b[lang] = trans, _b));
        }
    });
}
...
function default_1(outputPath, translationsPath) {
    ...
    var allFiles = languages.reduce(function (acc, lang) { return (acc.concat(fs.readdirSync(path.join(translationsPath, lang)))); }, []);
